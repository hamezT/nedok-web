module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        "neutralv11on-background": "var(--neutralv11on-background)",
      ...
      fontFamily: {
        ...
        "paragraph-x-small": "var(--paragraph-x-small-font-family)",
        "sub-heading-x-small": "var(--sub-heading-x-small-font-family)",
        "title-v1-1-medium": "var(--title-v1-1-medium-font-family)",
        sans: [
          "ui-sans-serif",
          "system-ui",
          "sans-serif",
